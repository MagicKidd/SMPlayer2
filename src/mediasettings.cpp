...
void MediaSettings::reset()
{
    ...
    current_edition_id = NoneSelected;
...
double MediaSettings::aspectToNum(Aspect aspect)
{
    ...
    switch (aspect) {
    case MediaSettings::AspectNone:
        asp = 0;
        break;
    case MediaSettings::Aspect43:
        asp = (double) 4 / 3;
        break;
    case MediaSettings::Aspect169:
        asp = (double) 16 / 9;
        break;
    case MediaSettings::Aspect149:
        asp = (double) 14 / 9;
        break;
    case MediaSettings::Aspect1610:
        asp = (double) 16 / 10;
        break;
    case MediaSettings::Aspect54:
        asp = (double) 5 / 4;
        break;
    case MediaSettings::Aspect235:
        asp = 2.35;
        break;
    case MediaSettings::Aspect11:
        asp = 1;
        break;
    case MediaSettings::Aspect32:
        asp = (double) 3 / 2;
        break;
    case MediaSettings::Aspect1410:
        asp = (double) 14 / 10;
        break;
...
QString MediaSettings::aspectToString(Aspect aspect)
{
    ...
    switch (aspect) {
    case MediaSettings::AspectNone:
        asp_name = QObject::tr("disabled", "aspect_ratio");
        break;
    case MediaSettings::Aspect43:
        asp_name = "4:3";
        break;
    ...
    case MediaSettings::Aspect1410:
        ...
        break;
    case MediaSettings::AspectAuto:
        asp_name = QObject::tr("auto", "aspect_ratio");
        break;
    default:
        asp_name = QObject::tr("unknown", "aspect_ratio");
    }
...
void MediaSettings::list()
{
    ...
    qDebug("  current_edition_id: %d", current_edition_id);
...
void MediaSettings::save(QSettings *set)
{
    ...
    set->setValue("current_edition_id", current_edition_id);
...
void MediaSettings::load(QSettings *set)
{
    ...
    current_edition_id = set->value("current_edition_id", current_edition_id).toInt();
